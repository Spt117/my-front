...
function SidebarMenuButton({
    ...
    // Classes de curseur conditionnelles avec priorité forcée
    const cursorClasses = disabled ? "!cursor-not-allowed hover:!cursor-not-allowed" : "cursor-pointer hover:cursor-pointer";

    const button = <Comp data-slot="sidebar-menu-button" data-sidebar="menu-button" data-size={size} data-active={isActive} disabled={disabled} style={disabled ? { cursor: "not-allowed" } : {}} className={cn(sidebarMenuButtonVariants({ variant, size }), cursorClasses, className)} {...props} />;
