                ...
                <CardContent className="grid flex gap-6 flex-wrap md:flex-nowrap md:grid-cols-2">
                    ...
                    <div className="relative w-full max-w-md min-w-[250px]">
                        ...
                        <div className="relative aspect-square mb-3">
                            <Image priority={true} src={images[currentImageIndex]?.image?.url || "/no_image.png"} alt={images[currentImageIndex]?.alt || product.title} fill sizes="10vw" className="object-cover rounded-lg" />
