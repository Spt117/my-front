...
import { beybladeTypes, IBeyblade, rotationDirections } from "@/app/beyblade/model/typesBeyblade";
...
export default function Beyblade() {
    ...
    const handleAddBeyblade = () => {
        if (
            beybladeForm.name &&
            beybladeForm.productCode &&
            beybladeForm.rotationDirection &&
            beybladeForm.type &&
            beybladeForm.parts
        ) {
                ...
                <CardContent className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-2">
                            ...
                            <Input
                                value={beybladeForm.productCode}
                                onChange={(e) => setBeybladeForm((prev) => ({ ...prev, productCode: e.target.value }))}
                                placeholder="BX-01"
                            />
                        </div>
                        <div className="space-y-2">
                            <Label>Name *</Label>
                            <Input
                                value={beybladeForm.name}
                                onChange={(e) => setBeybladeForm((prev) => ({ ...prev, name: e.target.value }))}
                    ...
                    <div className="grid grid-cols-3 gap-4">
                        <div className="space-y-2">
                            ...
                            <Select
                                value={beybladeForm.rotationDirection}
                                onValueChange={(v) => setBeybladeForm((prev) => ({ ...prev, rotationDirection: v as any }))}
                            >
                                <SelectTrigger>
                        ...
                        <div className="space-y-2">
                            <Label>Type *</Label>
                            <Select
                                value={beybladeForm.type}
                                onValueChange={(v) => setBeybladeForm((prev) => ({ ...prev, type: v as any }))}
                            >
                                <SelectTrigger>
                                    <SelectValue placeholder="Select" />
                                </SelectTrigger>
                        ...
                        <div className="space-y-2">
                            <Label>System</Label>
                            <Input
                                value={beybladeForm.system}
                                onChange={(e) => setBeybladeForm((prev) => ({ ...prev, system: e.target.value }))}
                                placeholder="X"
                            />
                        </div>
                    </div>
