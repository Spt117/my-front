import { IProductContentItem, typeBeybladeProductContent } from "@/app/beyblade/model/typesBeyblade";
        ...
        <Card className="mb-4">
            ...
            <CardContent className="space-y-4">
                ...
                <div className="grid gap-2">
                    ...
                    <Textarea id={`notes-${index}`} value={item.notes || ""} onChange={(e) => onUpdate(index, "notes", e.target.value)} placeholder="Special color, tournament edition, etc." rows={3} className="resize-none" />
                </div>
