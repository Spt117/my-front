...
export default function Launcher() {
    ...
    const handleAddLauncher = () => {
        if (
            launcherForm.productCode &&
            launcherForm.type &&
            launcherForm.system &&
            launcherForm.color &&
            launcherForm.rotationDirection
        ) {
                ...
                <CardContent className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-2">
                            ...
                            <Input
                                value={launcherForm.productCode}
                                onChange={(e) => setLauncherForm((prev) => ({ ...prev, productCode: e.target.value }))}
                                placeholder="BX-L01"
                            />
                        </div>
                        <div className="space-y-2">
                            <Label>Type *</Label>
                            <Select
                                value={launcherForm.type}
                                onValueChange={(v) => setLauncherForm((prev) => ({ ...prev, type: v as any }))}
                            >
                                <SelectTrigger>
                    ...
                    <div className="grid grid-cols-3 gap-4">
                        <div className="space-y-2">
                            <Label>System *</Label>
                            <Input
                                value={launcherForm.system}
                                onChange={(e) => setLauncherForm((prev) => ({ ...prev, system: e.target.value }))}
                                placeholder="X"
                            />
                        </div>
                        <div className="space-y-2">
                            <Label>Color *</Label>
                            <Input
                                value={launcherForm.color}
                                onChange={(e) => setLauncherForm((prev) => ({ ...prev, color: e.target.value }))}
                                placeholder="Blue"
                            />
                        </div>
                        <div className="space-y-2">
                            ...
                            <Select
                                value={launcherForm.rotationDirection}
                                onValueChange={(v) => setLauncherForm((prev) => ({ ...prev, rotationDirection: v as any }))}
                            >
                                <SelectTrigger>
                                    <SelectValue placeholder="Select" />
                                </SelectTrigger>
