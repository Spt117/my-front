import { IArena } from '@/app/oldBeyblade/model/typesBeyblade';
                ...
                <CardContent className="space-y-4">
                    <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-2">
                            ...
                            <Input value={arenaForm.productCode} onChange={(e) => setArenaForm((prev) => ({ ...prev, productCode: e.target.value }))} placeholder="BX-S01" />
                        </div>
                        <div className="space-y-2">
                            <Label>Color *</Label>
                            <Input value={arenaForm.color} onChange={(e) => setArenaForm((prev) => ({ ...prev, color: e.target.value }))} placeholder="Red" />
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-3 gap-4">
                        <div className="space-y-2">
                            <Label>System *</Label>
                            <Input value={arenaForm.system} onChange={(e) => setArenaForm((prev) => ({ ...prev, system: e.target.value }))} placeholder="X" />
                        </div>
                        <div className="space-y-2">
                        ...
                        <div className="space-y-2">
                            <Label>Gimmick</Label>
                            <Input value={arenaForm.gimmick} onChange={(e) => setArenaForm((prev) => ({ ...prev, gimmick: e.target.value }))} placeholder="X-treme" />
                        </div>
                    </div>
                    <ImageManager
