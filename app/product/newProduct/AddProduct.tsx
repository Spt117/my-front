...
import { createProductFromTitle } from "../serverAction";
...
export default function AddProduct() {
    const { addProductDialogOpen, closeAddProductDialog } = useProductStore();
        ...
        <>
            {addProductDialogOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center">
                    {/* Backdrop */}
                    <div className="absolute inset-0 bg-black/40" onClick={closeAddProductDialog} />
                    {/* Dialog */}
