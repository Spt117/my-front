export const cssCard = "shadow-lg border border-slate-300 bg-gradient-to-br from-slate-50 to-white w-full h-min";
...
const fieldsProduct = ["title", "descriptionHtml", "Statut", "Delete", "Handle"] as const;
