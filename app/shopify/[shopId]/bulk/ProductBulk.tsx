                ...
                <div className="flex-shrink-0">
                    <Link href={url} className="block">
                        <div className="relative w-20 h-20 rounded-md overflow-hidden border border-gray-200 hover:border-gray-400 transition-colors">
                            <Image src={product.media?.nodes[0].image?.url || '/no_image.png'} alt={product.title} fill className="object-cover" sizes="80px" />
                        </div>
                    </Link>
                </div>
                            ...
                            <div className="flex items-center flex-wrap gap-1">
                                {canaux.map((pub, idx) => (
                                    <p
                                        key={idx}
                                        className={`${
                                            pub.isPublished ? 'bg-green-50 text-green-700 border-green-200' : 'bg-red-50 text-red-700 border-red-200'
